...
const BASE_URL = "/MVC-Framework-From-Scratch/public/index.php";
const IMG_URL = "/MVC-Framework-From-Scratch/public";
const PUBLIC_URL = "/MVC-Framework-From-Scratch/public";
